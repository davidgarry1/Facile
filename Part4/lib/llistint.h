...
// CS 104 / Spring 2016
//
// This is a linked list of integers used in the underbelly of the stack
// data structure.
...
class LListInt {
 public:
  ...
  /**
   * NEW Assignment Operator (deep copy)
   */
  LListInt& operator=(const LListInt& other);

  /**
   * NEW Concatenation Operator (other should be appended to the end of this)
   */
